//
//  RadarsViewController+DFNSFetchResultsController.m
//  BeautifulRadars
//
...
#import "IP4ViewController+DFNSFetchResultsController.h"
#import "IPCell.h"

@implementation IP4ViewController (DFNSFetchResultsController) 
      ...
      newIndexPath:(NSIndexPath *)newIndexPath
{
    ...
    switch(type) {
        ...
        case NSFetchedResultsChangeUpdate: {
            RadarCell *cell =  (IPCell *)[tableView cellForRowAtIndexPath:indexPath];
