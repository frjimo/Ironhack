...
- (void)testThatCanAddPersonToHotel {
    Person *client1 = [Person personWithName:@"Fran" address:@"Ciudad Real"];
...
- (void)testThatAddManyPersonToHotel {
    Person *client1 = [Person personWithName:@"Fran" address:@"Ciudad Real"];
    Person *client2 = [Person personWithName:@"Tony" address:@"Madrid"];
    Person *client3 = [Person personWithName:@"Alex" address:@"Malaga"];
